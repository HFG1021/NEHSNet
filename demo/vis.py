...
from model.Model_F4_3A_5 import Model
...
def show3Dpose(vals, ax, fix_z):
    ...
    colors = [(255/255, 128/255, 255/255),
...
def get_pose3D(video_path, output_dir, fix_z):
    ...
    args.previous_dir = 'checkpoint/pretrained/GT'
    ...
    # Put the pretrained model in 'checkpoint/pretrained/243'
